      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="space-y-8 text-charcoal/70 leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using this website, you accept and agree to be bound by and comply with these Terms and Conditions. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Permission is granted to temporarily download one copy of the materials (information or software) on the KAVE website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal mb-4">4. Limitations</h2>
            <p>
              In no event shall KAVE or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on the KAVE website.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-charcoal mb-4">5. Accuracy of Materials</h2>
            <p>
              The materials appearing on the KAVE website could include technical, typographical, or photographic errors. KAVE does not warrant that any of the materials on the website are accurate, complete, or current. KAVE may make changes to the materials contained on its website at any time without notice.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal mb-4">7. Modifications</h2>
            <p>
              KAVE may revise these terms of service for its website at any time without notice. By using this website, you are agreeing to be bound by the then current version of these terms of service.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-charcoal mb-4">8. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal mb-4">9. Contact Information</h2>
            <p>
